...
static int ConvertYuv2Rgb565(unsigned char *inBuf, unsigned char *outBuf,int imgWidth, int imgHeight)
{
       int rows,cols;
       int y,u,v,r,g,b;
...
unsigned int convert_yuyv_to_rgb(unsigned char *inBuf, unsigned char *outBuf,int imgWidth, int imgHeight, int cvtMethod)
{
       int rows,cols;
       int y,u,v,r,g,b;
       unsigned char *YUVdata,*RGBdata;
